...
class procinp_exception : public std::exception {
 ...
 public:
  ...
  explicit procinp_exception( const std::string& name_in ) : name( name_in ) {}
};
...
class procinp_exception_variable_not_set : public procinp_exception {
 ...
 public:
  ...
  explicit procinp_exception_variable_not_set(const std::string& varname_in ) : procinp_exception ( "Variable not set" ), varname( varname_in ) { }
};
...
class procinp_exception_vector_length : public procinp_exception {
 ...
 public:
  std::string which() const { return varname; }
  explicit procinp_exception_vector_length( const std::string& varname_in ) : procinp_exception ( "Vector length invalid" ), varname( varname_in ) { }
};
...
class procinp_exception_readfail : public procinp_exception {
 ...
 public:
  std::string which() const { return varname; }
  explicit procinp_exception_readfail( const std::string& varname_in ) : procinp_exception ( "Variable read failed" ) , varname( varname_in ) { }
};
...
class input_variable_base {
 ...
 public:
  ...
  explicit input_variable_base( const std::string& name_in ) : name( name_in ), desc(), loaded(false) {}
